...
// SQL query to select all records from Normal_Colon_Exome_Datasets
$sql = "SELECT * FROM Normal_Colon_Exome_Datasets";
...
<body>
    <div class="container">
        <h3 text-align="left">Normal colon exome dataset information</h3>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td>' . $row["Layout"] . '</td>
                                 <td>
                                    <a href="view_details_normal_study.php?study_id='.$row["NCB_SRA_ID"].'" class="btn btn-info">Clinical Info</a>
                                </td>
                                </tr> 
                            ';
                        }
